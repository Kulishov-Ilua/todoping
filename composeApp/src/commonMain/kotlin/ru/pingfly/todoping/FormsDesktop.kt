...
@Composable
fun FormsEventDesktop(backgroungColor: Color, primaryColor: Color, secondColor: Color, themeColor: Color, onClose:()->Unit, onCreate:()->Unit){
...
@Composable
fun FormsTaskDesktop(backgroungColor: Color, primaryColor:Color, secondColor:Color, themeColor:Color, onClose:()->Unit, onCreate:()->Unit){
    var name = remember { mutableStateOf("") }
    var descr =  remember { mutableStateOf("") }
